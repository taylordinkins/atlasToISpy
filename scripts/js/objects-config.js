...
// Added line 238 (Taylor). Similar will be done for Atlas calos when added
...
ispy.event_description = {
  ...
  //Added AtlasTracks_V1
  "AtlasTracks_V1": {type: ispy.ASSOC, on: true, group: "Tracking", name: "AtlasTracks (Reco)",
    extra: "Points_V2", assoc: "MuonGlobalPoints_V2",
    fn: ispy.makeTrackPoints, style: {color: "rgb(100%, 100%, 0%)", opacity: 1.0, lineCaps: "square", linewidth: 1.5}, selection:{"min_pt":0, "index":0}},
  
  "GlobalMuons_V1": {type: ispy.ASSOC, on: true, group: "Muon", name: "Global Muons (Reco)",
